...
class Hangman:
    ...
    def choose_word(self):
        try:
            ...
            print "Whelp, we ran out of words to switch to -- better get it before you run out of guesses!"

    def narrow_word_pool(self):
        narrowed = set()
